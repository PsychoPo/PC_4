...
double medianQuickLinearFilterParallel(RGBTRIPLE** rgb_in, RGBTRIPLE** rgb_out, int height, int width, int ksize) {
    double time_start = omp_get_wtime();
...
double testMedianQuickLinearFilterParallel(RGBTRIPLE**& rgb_in, RGBTRIPLE**& rgb_out, int& height, int& width, int& ksize) {
    return medianQuickLinearFilterParallel(rgb_in, rgb_out, height, width, ksize);
}

char* inBMP(int i) {
    string str;
    str = "C:\\Users\\whoami\\source\\repos\\Parallel Computing\\lab_4\\input_X.bmp";
    char* cstr;
    switch (i)
    {
    case 1:
...
char* outBMP(int i, int alg) {
    string str;
    str = "C:\\Users\\whoami\\source\\repos\\Parallel Computing\\lab_4\\output_X_Y.bmp";
    char* cstr;
    switch (i)
    {
    case 1:
...
int main()
{
    ...
    void** FunctionsINT = new void* [6] { testMedianLinearFilter, testMedianGaussFilter, testMedianQuickLinearFilter, testMedianLinearFilterParallel,
        testMedianGaussFilterParallel, testMedianQuickLinearFilterParallel };
    string function_names[6]{ "Median Filter(Linear)", "Median Filter(Gauss)",
        "Median Filter(Quick Linear)", "Median Filter(Linear Parallel)", "Median Filter(Gauss Parallel)","Median Filter(Quick Linear Parallel)" };
